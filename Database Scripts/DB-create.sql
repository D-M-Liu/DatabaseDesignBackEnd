...
CREATE TABLE C##CAR.SWITCH_RECORDS (
    ...
    CONSTRAINT FK_SWITCH_RECORDS_BATTERY_OUT FOREIGN KEY (SWAPPED_OUT_BATTERY_ID)
        REFERENCES C##CAR.BATTERY (BATTERY_ID),
    CONSTRAINT FK_SWITCH_RECORDS_SWITCH_REQUESTS FOREIGN KEY (LONGITUDE)
        REFERENCES C##CAR.SWITCH_REQUESTS (LONGITUDE),
    CONSTRAINT FK_SWITCH_RECORDS_SWITCH_REQUESTS FOREIGN KEY (LATITUDE)
        REFERENCES C##CAR.SWITCH_REQUESTS (LATITUDE),
    CONSTRAINT FK_SWITCH_RECORDS_SWITCH_REQUESTS FOREIGN KEY (POSITION)
